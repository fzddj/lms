<template>
    <!--<wxc-tab-bar :tab-titles="tabTitles"-->
        ...
        <!--&lt;!&ndash; 第二个页面内容&ndash;&gt;-->
        <!--<div class="item-container" :style="contentStyle"><customer></customer></div>-->

        <!--&lt;!&ndash; 第三个页面内容&ndash;&gt;-->
        <!--<div class="item-container" :style="contentStyle"><statistics></statistics></div>-->
...
<script>
    ...
    import popsover from '../../components/popsover';
    import search from '../../components/search';
