<template>
    <div>
        ...
        <div :style="{'margin-top':listHeight+'px'}">
            <wxc-button :btn-style="btnStyle" @wxcButtonClicked="addBooking()" text="提交"></wxc-button>
        </div>
...
<script>
    ...
    export default {
        ...
        created () {
            ...
            this.customerId = this.getItem("customerBookingCarId");
