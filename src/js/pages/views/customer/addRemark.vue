    ...
    <div>
        <div class="customer-detail-from">
            ...
            <div class="customer-item-row" v-if="customerStatus == 0">
                <div class="customer-item-row-left" @click="modifyLevel()">
                    <text class="iconfont text-font-weight iconfont-color">{{params.level}}</text>
                    <text>意向等级</text>
                </div>
                <div  class="customer-item-row-right" @click="customerDefeat()">
                    <text class="iconfont iconfont-color">&#xe6c9;</text>
                    <text>申请战败</text>
                </div>
            </div>

            <div class="customer-item-row" v-if="customerStatus == 1">
                <div  class="customer-remark-item-row" @click="customerDefeat()">
                    <text class="iconfont iconfont-color">&#xe6c9;</text>
                    <text>申请战败</text>
                </div>
            </div>
            ...
            <div class="customer-item-row" v-if="customerStatus == 2">
                <div class="customer-item-row-left" @click="addCustomerClick()">
                    <text class="iconfont  iconfont-color">&#xe74f;</text>
                    <text>增换购车</text>
                </div>
                <div  class="customer-item-row-right" @click="addCustomerClick()">
                    <text class="iconfont  iconfont-color">&#xe7bf;</text>
                    <text>介绍客户</text>
                </div>
            </div>

            <div class="customer-item-row" v-if="customerStatus == 3">
                <div  class="customer-remark-item-row" @click="modifyLevel()">
                    <text class="iconfont iconfont-color">战败</text>
                    <text>战败激活</text>
                </div>
            </div>
        </div>
        ...
        <div :style="{'margin-top':listHeight+'px'}">
            <wxc-button :btn-style="btnStyle" @wxcButtonClicked="addRemark()" text="提交"></wxc-button>
        </div>
            ...
            remarkInit() {
                ...
                this.GET(url,function(resp){
                    ...
                    if (resp.status == 200 && resp.data.data != null && resp.data.data != undefined
                        ...
                        // console.log("customerStatus",that.customerStatus );
                    }
                })
            },
            customerDefeat() {
