<template>
    <div>
        <div class="condition-row">
            <div class="condition-item one" @click="buyDateClick()">
                <div class="condition-item-text">
                    <text class="condition-item-text-value">购车日期</text>
                </div>
                ...
                <cell class="cell" v-for="info in infoList">
                    <div class="panel" @click="getInfoDetail(info.customerId)">
                        ...
                        <div class="panel-info">
                            <text class="panel-info-text">成交车型：{{info.seriesName}}-{{info.modelName}}</text>
                            <text class="panel-info-text">成交金额：{{info.dealPrice}}</text>
                            <text class="panel-info-text">购车日期：{{info.deliveryCarTime}}</text>
                        </div>
    ...
    export default {
        ...
        methods: {
            ...
            buyDateClick() {
                ...
                this.getInfoList(this.getCarSort);
            },
            getPhone(phone) {
                return "tel://"+phone;
            },
            getInfoDetail(id) {
                this.setItem("customerDeliveryCarId",id);
                this.jump("customerDeliveryCarDetail");
            },
            getInfoList(getCarSort = null) {
                let that = this;
