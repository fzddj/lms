<template>
    <div>
        ...
        <div :style="{'margin-top':listHeight+'px'}">
            ...
            <div class="w-button button-three">
                <wxc-button :btn-style="btnStyle" @wxcButtonClicked="modifyLevel()" text="战败激活"></wxc-button>
            </div>
        </div>
            ...
            customerDetailInit() {
                ...
                this.GET(url3,function(response){
                    ...
                    if (response.status == 200 && response.data.data != null && response.data.data != undefined) {
                        console.log("testData1",response);
