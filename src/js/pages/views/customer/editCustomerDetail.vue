...
<script>
    ...
    export default {
        ...
        created () {
            let customerId = this.getItem("editCustomerDetailId");
        ...
        methods: {
            ...
            editCustomer() {
                ...
                let expand = {};
                // 家庭成员
                if (this.familyMember != null && this.familyMember != "" && this.familyMember != undefined ) {
                    expand['familyMember'] = this.familyMember;
                }
            ...
            addCustomer() {
                ...
                this.POST(url,obj,"json",function(resp) {
                    if (resp.status == 200 && resp.data.data != null && resp.data.data != undefined
                        ...
                        console.log("addCustomer",resp.data.data);

                        // todo 页面跳转是否需要切换页面至会员
                        that.jump("home");
            ...
            customerDetailInit() {
                ...
                this.GET(url,function(resp){
                    if (resp.status == 200 && resp.data.data != null && resp.data.data != undefined
                        ...
                        that.intentionLevel = resp.data.data.level;
