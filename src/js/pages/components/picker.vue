        ...
        <transition name="fade">
            <div class="area_ctrl">
                ...
                <div class="area_roll_mask">
                    <div class="area_roll">
                        <div class="area_item">
                            <div top="0" :class="['gear','area_province',selectData.columns == 1? 'gear-left-add':'gear-left']"
                        ...
                        <div v-if="selectData.columns > 1" class="area_item">
                        ...
                        <div v-if="selectData.columns > 2" class="area_item">
