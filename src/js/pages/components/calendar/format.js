...
const TRADITIONAL_HOLIDAY = {
    '除夕': ['2015-02-18', '2016-02-07', '2017-01-27', '2018-02-15', '2019-02-04', '2020-01-24','2021-02-11','2022-01-31'],
    '春节': ['2015-02-19', '2016-02-08', '2017-01-28', '2018-02-16', '2019-02-05', '2020-01-25','2021-02-12','2022-02-01'],
    '元宵': ['2015-03-05', '2016-02-22', '2017-02-11', '2018-03-02', '2019-02-19', '2020-02-08','2021-02-26','2022-02-15'],
    '清明': ['2015-04-05', '2016-04-04', '2017-04-04', '2018-04-05', '2019-04-05', '2020-04-04','2021-04-04','2022-04-05'],
    '端午': ['2015-06-20', '2016-06-09', '2017-05-30', '2018-06-18', '2019-06-07', '2020-06-25','2021-06-14','2022-06-03'],
    '中秋': ['2015-09-27', '2016-09-15', '2017-10-04', '2018-09-24', '2019-09-13', '2020-10-01','2021-09-21','2022-09-10'],
    '重阳': ['2015-10-21', '2016-10-09', '2017-10-28', '2018-10-17', '2019-10-07', '2020-10-25','2021-10-14','2022-10-04']
};
...
export function generateDateCellNew ({ dateRangeInfo, today, departDate, arriveDate, selectedNote, descList }) {
    const start = new Date(dateRangeInfo[0].replace(/-/g, '/'));
    const end = new Date(dateRangeInfo[1].replace(/-/g, '/'));
    const startYear = start.getFullYear();
    const startMonth = start.getMonth() + 1;
    const endYear = end.getFullYear();
    const endMonth = start.getMonth() + 1;
    ...
    for (let i = 0; i < l; i++) {
        ...
        months.push(
            { title: `${y}-${_fixNum(n)}` },
            ...getWeekRows(y, n, today, dateRangeInfo, departDate, arriveDate, selectedNote, descList)
        );
        n++;
    }
    return months
